 ...
 * any publisher information then check dcat:landingPage because as per
 * Data Catalog(https://www.w3.org/TR/vocab-dcat-1/) landingPage has range 
 * of foaf:Document which is used with publication as well.
 * 
 * If landingPage in dataset is not available then check accessURL in all the 
 * distributions based on percentage of availability of accessURL, this metric 
 * provides a score for "Provider Identity".
 * 
 * @see https://www.w3.org/TR/vocab-dcat-1/#Property:catalog_publisher
 * @see https://www.w3.org/TR/vocab-dcat-1/#Property:distribution_accessurl
 * @see https://www.w3.org/TR/vocab-dcat-1/#Property:dataset_landingpage
 * 
 * @author Gourab Sahu
 */
